...
list(
  ...
  tar_target(export_lung_negative_control_genus_composition_plot, tar_ggsave(lung_negative_control_genus_composition_plot,file.path(basic_stata_output_dir, "lung_negative_control_genus_composition.pdf"),width=20,height=10), format = "file"),

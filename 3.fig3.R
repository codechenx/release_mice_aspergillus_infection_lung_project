...
list(
  ...
  # # alpha diversity
  # tar_target(lung_alpha_plot_df, get_all_alpha_diversity(lung_subset_decontam_genus_physeq), pattern = lung_subset_decontam_genus_physeq, iteration = "list"),
  # tar_target(lung_combined_all_alpha, bind_rows(lung_alpha_plot_df)),
  # tar_target(gut_alpha_plot_df, get_all_alpha_diversity(gut_subset_decontam_genus_physeq), pattern = gut_subset_decontam_genus_physeq, iteration = "list"),
  # tar_target(gut_combined_all_alpha, bind_rows(gut_alpha_plot_df)),


  # beta diversity
  tar_target(lung_beta_plot, plot_fig3_beta(fig3_lung_decontam_genus_physeq,plot_title="Lung tissue microbiome")),
  tar_target(gut_beta_plot, plot_fig3_beta(fig3_gut_decontam_genus_physeq,plot_title="Gut tissue microbiome")),
  # plsda

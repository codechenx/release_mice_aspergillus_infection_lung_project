...
list(
  ...
  tar_target(lung_beta_plot, plot_fig4_microbiome_distance(fig4_lung_decontam_genus_physeq,plot_title="Lung tissue microbiome")),
  tar_target(gut_beta_plot, plot_fig4_microbiome_distance(fig4_gut_decontam_genus_physeq,plot_title="Gut tissue microbiome")),
  ...
  tar_target(lung_microbiome_constant_changing_plot, plot_constant_taxa(lung_decontam_genus_rl_physeq, lung_microbiome_constant_changing_taxa, plot_lab="Lung tissue microbiome")),
  tar_target(gut_microbiome_constant_changing_plot, plot_constant_taxa(gut_decontam_genus_rl_physeq, gut_microbiome_constant_changing_taxa, plot_lab="Gut tissue microbiome")),
